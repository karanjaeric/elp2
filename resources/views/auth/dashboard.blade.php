    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link pt-5">
                <img src="https://davikani.s3.eu-west-3.amazonaws.com/images/logo/logo.png" alt="techhub logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="https://davikani.s3.eu-west-3.amazonaws.com/profiles/{{Auth()->user()->image}}"
